...
""")
graph.run("CREATE INDEX IF NOT EXISTS FOR (k:Keyword) ON (k.name)")
...
STAKEHOLDERS = [
  # id, name, type, sector, location, description, keywords
...
PROJECTS = [
  # id, name, description, location, keywords, sdgs
